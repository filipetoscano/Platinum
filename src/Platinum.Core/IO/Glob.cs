...
namespace Platinum.IO
{
    public static class Glob
    {
        ...
        /// </param>
        /// <returns>
        /// A sorted list of files matching the given path pattern, or
        /// null if no patterns were provided.
        /// </returns>
        ...
        /// <summary>
        /// Performs globbing of a single path pattern.
        /// </summary>
        /// <param name="pattern">
        /// Path pattern.
        /// </param>
        /// <returns>
        /// A list of files matching the given path pattern.
        /// </returns>
