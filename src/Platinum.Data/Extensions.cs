...
namespace Platinum.Data
{
    ...
    public static class Extensions
    {
        ...
        /// <param name="command">Command.</param>
        /// <returns>Value of first selected cell, as enumerate.</returns>
        public async static Task<T> ExecuteEnumAsync<T>( this DbConnection cnn, CommandDefinition command )
        {
            string scalar = await cnn.ExecuteScalarAsync<string>( command );
        ...
        /// <param name="commandType">Type of command.</param>
        /// <returns>Value of first selected cell, as enumerate.</returns>
        public static async Task<T> ExecuteEnumAsync<T>( this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = default( int? ), CommandType? commandType = default( CommandType? ) )
        {
            string scalar = await cnn.ExecuteScalarAsync<string>( sql, param, transaction, commandTimeout, commandType );
